...
unit_2.samples.create(internal_id: '320PP105', taked_at: 3.days.ago, received_at: 2.days.ago, reported_at: 1.day.ago) do |sample|
	sample.lubricant.variables.each_with_index do |variable, index|
...
unit_3.samples.create(internal_id: '320PP106', taked_at: 23.days.ago, received_at: 2.days.ago, reported_at: 1.day.ago) do |sample|
	sample.lubricant.variables.each_with_index do |variable, index|
...
unit_4.samples.create(internal_id: '320PP107', taked_at: 3.days.ago, received_at: 2.days.ago, reported_at: 1.day.ago) do |sample|
	sample.lubricant.variables.each_with_index do |variable, index|
...
sample_5 = [1, 1, 1, 1, 1]
unit_5.samples.create(internal_id: '320PP108', taked_at: 3.days.ago, received_at: 2.days.ago, reported_at: 1.day.ago) do |sample|
	sample.lubricant.variables.each_with_index do |variable, index|
...
unit_6.samples.create(internal_id: '320PP109', taked_at: 3.days.ago, received_at: 2.days.ago, reported_at: 1.day.ago) do |sample|
	sample.lubricant.variables.each_with_index do |variable, index|
...
unit_7.samples.create(internal_id: '320PP110', taked_at: 3.days.ago, received_at: 2.days.ago, reported_at: 1.day.ago) do |sample|
	sample.lubricant.variables.each_with_index do |variable, index|
...
unit_8.samples.create(internal_id: '320PP111', taked_at: 31.days.ago, received_at: 2.days.ago, reported_at: 1.day.ago) do |sample|
	sample.lubricant.variables.each_with_index do |variable, index|
